package net.generica.spring.masteringspringappdev.repositories
...
class ProductRepository {
    ...
    /**
     * Create a {@link Product} collection if the collection does not already exists
     */
